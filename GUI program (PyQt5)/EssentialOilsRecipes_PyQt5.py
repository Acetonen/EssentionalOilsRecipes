...
from PyQt5.QtWidgets import (QWidget, QPushButton, QApplication, qApp,
                             ...
                             QAction, QLabel, QInputDialog, QTextBrowser)
#PEP8
...
class MainWindow(QMainWindow):
    ...
    def main_meny_UI(self):
        ...
        exit_act.triggered.connect(self.closeEvent) # connect to quit
        ...
        all_recipe_act.triggered.connect(self.recipes)
        ...
        create_recipe_act.triggered.connect(self.creation_recipe)
...
ингрдиетнов')
        avail_recipe_act.triggered.connect(self.available_recipe)
...
присутствующие в рецептах')
        ing_from_recipe_act.triggered.connect(self.ing_from_rec)
        ...
        delete_recipe_act.triggered.connect(self.delete_recipe)
        ...
        rate_recipe_act.triggered.connect(self.recipe_rate)
        ...
        rec_with_ing_act.triggered.connect(self.rec_with_ing)
